              ...
              <div class="task-item">
                <div class="task-item-bd" :title="item.id">
                  ...
                  <div class="task-item-subt">
                    <template v-if="item.state === 'archived'">{{ item.last_failed_at }}</template>
                    <template v-else>{{ item.completed_at }}</template>
                  </div>
                </div>
                <i class="material-icons" v-if="item.state === 'active'">sync</i>
                <i class="material-icons" v-if="item.state === 'archived'">block</i>
                <i class="material-icons" v-if="item.state === 'completed'">done</i>
                <button
                  class="action"
